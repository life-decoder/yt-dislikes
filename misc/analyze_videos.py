"""
Analyze YouTube videos and their comment sentiment data.

This script compares the comments_sentiment_all.csv file with the youtube_dislike_dataset.csv
to identify:
- The number of unique videos that have comment sentiment data
- The first and last video IDs in the comments dataset and their corresponding rows
  in the dislike dataset
- Videos in the dislike dataset that are missing comment sentiment data within the range
  of videos that have comments

The script provides detailed statistics and reports on video coverage between the two datasets.
"""
